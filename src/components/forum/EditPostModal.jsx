...
export default function EditPostModal({ post, onClose, onSave }) {
  const [formData, setFormData] = useState({
    ...
    tags: post.tags,
    images: post.images || [] // Thêm images
  })
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-blue-300 bg-blue-50/50 rounded-xl cursor-pointer hover:bg-blue-100 hover:border-blue-400 transition-all duration-300 group">
                <i className="fa-solid fa-image text-blue-600 text-xl group-hover:scale-110 transition-transform" />
                <span className="text-blue-700 font-medium">Chọn ảnh từ máy tính</span>
                <input
                  type="file"
                  accept="image/*"
                  multiple
