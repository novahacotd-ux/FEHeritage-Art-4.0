...
const AnalysisCard = ({ article, categories, onClick }) => {
  return (
    <div
      className="flex-shrink-0 w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(33.33%-0.67rem)] bg-white/90 backdrop-blur-sm rounded-2xl shadow-md hover:shadow-2xl transition-all hover:-translate-y-2 cursor-pointer border-2 border-amber-100 hover:border-amber-300 group"
    ...
    >
      ...
      <div className="p-4 sm:p-5">
        <h4 className="flex gap-2 mb-2 line-clamp-2 text-gray-800 group-hover:text-amber-700 transition-colors font-semibold text-sm sm:text-base">
          <span>
