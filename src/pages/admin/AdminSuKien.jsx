...
const initialEvents = [
    {
        ...
        content:
            "<p>Sự kiện quy tụ hơn 5.000 người tham gia với nhiều hoạt động văn hóa biển.</p>",
        thumbnail: "",
    },
    {
        id: "E-002",
        ...
        content:
            "<p>Trưng bày kết hợp trải nghiệm thực tế ảo giúp người xem tiếp cận nghệ thuật dân gian.</p>",
        thumbnail: "",
    },
];
    ...
    return (
        <>
            <style>{`
                ...
                .admin-sukien-card:hover {
                    border-color: #38bdf8;
                    box-shadow: 0 4px 12px 0 #60a5fa38;
                }
                .admin-sukien-modal-anim {
            ...
            <div className="w-full flex flex-col gap-8 mt-4">
                ...
                <div className="flex items-center justify-between py-4 px-6 bg-white border-b border-blue-100 rounded-t-lg">
                    <div>
                        <h2 className="text-xl font-bold text-blue-700">Sự kiện</h2>
                        <p className="text-gray-500 text-sm">
                            Quản lý sự kiện: tiêu đề, mô tả, nội dung, ảnh đại diện
                        </p>
                    </div>
                    <button
                    ...
                    <div className="bg-white rounded-xl shadow border border-blue-100 p-6 flex flex-col">
                        ...
                        <div className="flex flex-col gap-4">
                            {items.map((item) => (
                                <div
                                    key={item.id}
                                    className="admin-sukien-card flex flex-col border border-blue-50 rounded-lg shadow-sm p-4 bg-blue-50 transition-all"
                                >
                    ...
                    <div className="bg-white rounded-xl shadow border border-blue-100 p-6">
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <label className="input-file-label" htmlFor="admin-thumbnail-sk-input">
                ...
                {viewItem && (
                    <div className="fixed inset-0 bg-black bg-opacity-30 z-[9999] flex items-center justify-center">
                        <div className="admin-sukien-modal-anim bg-white rounded-xl shadow-xl max-w-xl w-full p-6 relative border border-blue-200">
